...
/**
 * Social media share buttons for Twitter/X, Facebook, WhatsApp, and LinkedIn
 */
    ...
    <div className={`flex flex-col items-center gap-2 ${className}`}>
      <Tooltip content="Share on X (Twitter)">
        <Button
          ...
          size="sm"
          variant="flat"
          className="bg-gray-800/50 hover:bg-yellow-900/30 min-w-8 w-8 h-8"
          onPress={() => openShare("twitter")}
